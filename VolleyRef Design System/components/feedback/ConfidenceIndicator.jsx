...
export function ConfidenceIndicator({ level = 'high', showWhenHigh = false, message }) {
  ...
  return (
    <Tooltip content={text}>
      <span aria-label={text} style={{ display: 'inline-block', width: 7, height: 7, borderRadius: '50%', background: color, boxShadow: level === 'low' ? '0 0 0 3px rgba(226,161,0,0.18)' : 'none' }} />
    </Tooltip>
  );
}
